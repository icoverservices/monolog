...
/**
 * @covers Icoverlog\Formatter\NormalizerFormatter
 */
class NormalizerFormatterTest extends TestCase
{
    public function testFormat()
    {
        ...
        $this->assertEquals([
            ...
            'datetime' => date('Y-m-d'),
            'extra' => [
                'foo' => ['Icoverlog\\Formatter\\TestFooNorm' => ["foo" => "fooValue"]],
                'bar' => ['Icoverlog\\Formatter\\TestBarNorm' => 'bar'],
                'baz' => [],
                'res' => '[resource(stream)]',
            ],
            'context' => [
    ...
    {
        $serialized = "O:17:\"Icoverlog\TestClass\":1:{s:23:\"\x00Icoverlog\TestClass\x00name\";s:4:\"test\";}";
        ...
        $this->assertEquals([
            '__PHP_Incomplete_Class' => 'Icoverlog\\TestClass',
