...
/**
 * @covers Icoverlog\Formatter\LineFormatter
 */
class LineFormatterTest extends TestCase
{
    ...
    public function testDefFormatWithObject()
    {
        ...
        $this->assertEquals('['.date('Y-m-d').'] meh.ERROR: foobar [] {"foo":{"Icoverlog\\\\Formatter\\\\TestFoo":{"foo":"fooValue"}},"bar":{"Icoverlog\\\\Formatter\\\\TestBar":"bar"},"baz":[],"res":"[resource(stream)]"}'."\n", $message);
    }
