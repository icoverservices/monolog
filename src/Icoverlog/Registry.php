...
/**
 * Icoverlog log registry
 *
 * Allows to get `Logger` instances in the global scope
 * via static method calls on this class.
 *
 * <code>
 * $application = new Icoverlog\Logger('application');
 * $api = new Icoverlog\Logger('api');
 *
 * Icoverlog\Registry::addLogger($application);
 * Icoverlog\Registry::addLogger($api);
 *
 * function testLogger()
 * {
 *     Icoverlog\Registry::api()->error('Sent to $api Logger instance');
 *     Icoverlog\Registry::application()->error('Sent to $application Logger instance');
 * }
 * </code>
 *
