...
namespace Icoverlog\Handler\Slack;

use Icoverlog\Level;
use Icoverlog\Test\TestCase;

/**
 * @coversDefaultClass Icoverlog\Handler\Slack\SlackRecord
 */
class SlackRecordTest extends TestCase
{
    ...
    public function testTextEqualsFormatterOutput()
    {
        ...
        $formatter2 = $this->createMock('Icoverlog\\Formatter\\FormatterInterface');
        $formatter2
            ->expects($this->any())
            ->method('format')
            ->will($this->returnCallback(function ($record) {
