...
use Icoverlog\Formatter\FormatterInterface;
use Icoverlog\Level;
use Icoverlog\Utils;
...
/**
 * Icoverlog handler for Google Chrome extension "PHP Console"
 *
 ...
 *
 *      $logger = new \Icoverlog\Logger('all', array(new \Icoverlog\Handler\PHPConsoleHandler()));
 *      \Icoverlog\ErrorHandler::register($logger);
 *      echo $undefinedVar;
 ...
 * }
 *
 * @deprecated Since 2.8.0 and 3.2.0, PHPConsole is abandoned and thus we will drop this handler in Icoverlog 4
 */
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private array $options = [
        ...
        'classesPartialsTraceIgnore' => ['Icoverlog\\'], // array Hide calls of classes started with...
    ...
    /**
     * @param  array<string, mixed> $options   See \Icoverlog\Handler\PHPConsoleHandler::$options for more details
