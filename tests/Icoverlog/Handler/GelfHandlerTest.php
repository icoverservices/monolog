...
use Icoverlog\Level;
use Icoverlog\Formatter\GelfMessageFormatter;
...
class GelfHandlerTest extends TestCase
{
    ...
    /**
     * @covers Icoverlog\Handler\GelfHandler::__construct
     */
    public function testConstruct()
    {
        $handler = new GelfHandler($this->getMessagePublisher());
        $this->assertInstanceOf('Icoverlog\Handler\GelfHandler', $handler);
    }
