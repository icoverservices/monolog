 ...
 * @coversDefaultClass Icoverlog\Handler\SlackWebhookHandler
 */
class SlackWebhookHandlerTest extends TestCase
{
    ...
    public function testConstructorMinimal()
    {
        ...
        $this->assertInstanceOf('Icoverlog\Handler\Slack\SlackRecord', $slackRecord);
        $this->assertEquals([
            'attachments' => [
                [
                    'fallback' => 'test',
    ...
    public function testGetFormatter()
    {
        ...
        $this->assertInstanceOf('Icoverlog\Formatter\FormatterInterface', $formatter);
    }
