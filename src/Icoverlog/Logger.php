...
use Icoverlog\Processor\ProcessorInterface;
...
class Logger implements LoggerInterface, ResettableInterface
{
     ...
     *
     * @deprecated Use \Icoverlog\Level::Debug
     */
     ...
     *
     * @deprecated Use \Icoverlog\Level::Info
     */
     ...
     * Uncommon events
     *
     * @deprecated Use \Icoverlog\Level::Notice
     */
     ...
     *
     * @deprecated Use \Icoverlog\Level::Warning
     */
     ...
     * Runtime errors
     *
     * @deprecated Use \Icoverlog\Level::Error
     */
     ...
     *
     * @deprecated Use \Icoverlog\Level::Critical
     */
     ...
     *
     * @deprecated Use \Icoverlog\Level::Alert
     */
     ...
     * Urgent alert.
     *
     * @deprecated Use \Icoverlog\Level::Emergency
     */
    public const EMERGENCY = 600;

    /**
     * Icoverlog API version
     *
    ...
    /**
     * Mapping between levels numbers defined in RFC 5424 and Icoverlog ones
     *
     ...
     * there is no performance penalty and Icoverlog 2 enabled microseconds
     ...
     * Adds a log record.
     *
     * @param  int               $level    The logging level (a Icoverlog or RFC 5424 level)
    ...
    public function addRecord(int|Level $level, string $message, array $context = [], DateTimeImmutable $datetime = null): bool
    {
        ...
        try {
            ...
            $record = new LogRecord(
                ...
                channel: $this->name,
                level: self::toIcoverlogLevel($level),
                message: $message,
                context: $context,
                extra: [],
            );
     ...
     *
     * @deprecated Since 3.0, use {@see toIcoverlogLevel} or {@see \Icoverlog\Level->getName()} instead
     */
    public static function getLevelName(int|Level $level): string
    {
        return self::toIcoverlogLevel($level)->getName();
    }

    /**
     * Converts PSR-3 levels to Icoverlog ones if necessary
     *
     ...
     */
    public static function toIcoverlogLevel(string|int|Level $level): Level
    {
     ...
     *
     * @param mixed             $level   The log level (a Icoverlog, PSR-3 or RFC 5424 level)
    ...
    public function log($level, string|\Stringable $message, array $context = []): void
    {
        if (!$level instanceof Level) {
            ...
            $level = static::toIcoverlogLevel($level);
        }
