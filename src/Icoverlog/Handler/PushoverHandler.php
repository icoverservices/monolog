...
class PushoverHandler extends SocketHandler
{
    ...
    public function __construct(
        ...
        $this->highPriorityLevel = Logger::toIcoverlogLevel($highPriorityLevel);
        $this->emergencyLevel = Logger::toIcoverlogLevel($emergencyLevel);
        $this->retry = $retry;
        $this->expire = $expire;
    }
    ...
    {
        $this->highPriorityLevel = Logger::toIcoverlogLevel($level);
    ...
    {
        $this->emergencyLevel = Logger::toIcoverlogLevel($level);
