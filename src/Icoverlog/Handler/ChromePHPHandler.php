...
use Icoverlog\Formatter\ChromePHPFormatter;
use Icoverlog\Formatter\FormatterInterface;
use Icoverlog\Level;
use Icoverlog\Utils;
use Icoverlog\LogRecord;
use Icoverlog\DateTimeImmutable;
...
class ChromePHPHandler extends AbstractProcessingHandler
{
    ...
    public function __construct(int|string|Level $level = Level::Debug, bool $bubble = true)
    {
        ...
        if (!function_exists('json_encode')) {
            throw new \RuntimeException('PHP\'s json extension is required to use Icoverlog\'s ChromePHPHandler');
        }
    }
