...
use Icoverlog\Handler\HandlerInterface;
use Icoverlog\Processor\WebProcessor;
use Icoverlog\Handler\TestHandler;
...
class LoggerTest extends TestCase
{
    ...
    /**
     * @covers Logger::toIcoverlogLevel
     */
    public function testConvertPSR3ToIcoverlogLevel()
    {
        $this->assertEquals(Logger::toIcoverlogLevel('debug'), Level::Debug);
        $this->assertEquals(Logger::toIcoverlogLevel('info'), Level::Info);
        $this->assertEquals(Logger::toIcoverlogLevel('notice'), Level::Notice);
        $this->assertEquals(Logger::toIcoverlogLevel('warning'), Level::Warning);
        $this->assertEquals(Logger::toIcoverlogLevel('error'), Level::Error);
        $this->assertEquals(Logger::toIcoverlogLevel('critical'), Level::Critical);
        $this->assertEquals(Logger::toIcoverlogLevel('alert'), Level::Alert);
        $this->assertEquals(Logger::toIcoverlogLevel('emergency'), Level::Emergency);
    }

    /**
     * @covers Icoverlog\Logger::addRecord
     * @covers Icoverlog\Logger::log
     */
    public function testConvertRFC5424ToIcoverlogLevelInAddRecordAndLog()
    {
    ...
    public function testLog()
    {
        ...
        $handler = $this->getMockBuilder('Icoverlog\Handler\HandlerInterface')->getMock();
    ...
    {
        $logger = new Logger(__METHOD__);
        $handler = $this->createMock('Icoverlog\Handler\HandlerInterface');
        ...
        $processor = $this->getMockBuilder('Icoverlog\Processor\WebProcessor')
    ...
    public function testHandlersNotCalledBeforeFirstHandlingWhenProcessorsPresent()
    {
        ...
        $handler1 = $this->createMock('Icoverlog\Handler\HandlerInterface');
        ...
        $handler2 = $this->createMock('Icoverlog\Handler\HandlerInterface');
        ...
        $handler3 = $this->createMock('Icoverlog\Handler\HandlerInterface');
