...
namespace Icoverlog\Handler\FingersCrossed;
...
class ChannelLevelActivationStrategy implements ActivationStrategyInterface
{
    ...
    {
        $this->defaultActionLevel = Logger::toIcoverlogLevel($defaultActionLevel);
        $this->channelToActionLevel = array_map(Logger::toIcoverlogLevel(...), $channelToActionLevel);
    }
