 ...
 *
 * Icoverlog supports the logging levels described by RFC 5424 {@see https://datatracker.ietf.org/doc/html/rfc5424}
 ...
 *
 * - Use ->getName() to get the standard Icoverlog name which is full uppercased (e.g. "DEBUG")
